...
// QUARTZPLAY SPORTS â€” Design System
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
const Q = {
  ...
  return(
    <div style={{display:"flex",gap:10,alignItems:"flex-start",marginBottom:16}}>
      <div style={{width:36,height:36,borderRadius:"50%",
        ...
        fontSize:18,flexShrink:0,boxShadow:`0 0 12px ${Q.violet}44`}}>â¬¡</div>
      <div style={{flex:1}}>
        ...
        <GCard style={{padding:"14px"}}>
          ...
          <div style={{textAlign:"right",marginTop:6,color:Q.muted,fontSize:9,
            fontFamily:"'Space Grotesk',system-ui"}}>{time} âœ“âœ“</div>
        </GCard>
      </div>
    </div>
  );
  ...
  return(
    <div style={{display:"flex",justifyContent:"flex-end",marginBottom:16}}>
      <GCard glow={Q.violet} style={{padding:"12px 14px",maxWidth:"75%",
        ...
        <div style={{textAlign:"right",marginTop:4,color:Q.muted,fontSize:9}}>{time} âœ“âœ“</div>
      </GCard>
    </div>
  );
}
  ...
  return(
    <div style={{background:Q.deep,borderBottom:`1px solid ${Q.border}`,
      ...
      {onBack&&<button onClick={onBack} style={{background:"transparent",border:"none",
        color:Q.muted,fontSize:26,cursor:"pointer",padding:0,lineHeight:1}}>â€¹</button>}
      <div style={{width:40,height:40,borderRadius:"50%",
        background:`linear-gradient(135deg,${Q.violet},${Q.cyan})`,
        display:"flex",alignItems:"center",justifyContent:"center",
        fontSize:20,flexShrink:0,boxShadow:`0 0 14px ${Q.violet}66`}}>â¬¡</div>
      <div style={{flex:1}}>
...
const SPORTS = [
  {icon:"ðŸ†",name:"Mundial 2026",events:[
    ...
    {id:"w3",h:"EspaÃ±a",   a:"C.Verde",  time:"17:00",odds:{L:1.18,E:7.50,V:14.0}},
    {id:"w4",h:"Francia",  a:"Senegal",  time:"20:00",odds:{L:1.45,E:4.50,V:7.00}},
  ]},
  {icon:"ðŸ‡¦ðŸ‡·",name:"Liga Argentina",events:[
    ...
    {id:"a3",h:"San Lorenzo",a:"HuracÃ¡n",time:"18:00",odds:{L:2.30,E:3.10,V:3.10}},
  ]},
  {icon:"âš½",name:"Champions League",events:[
  ...
  {icon:"ðŸŽ¾",name:"Wimbledon",events:[
  ...
  {icon:"ðŸˆ",name:"NFL",events:[
    {id:"f1",h:"Chiefs",   a:"Eagles",   time:"Dom 22:00",odds:{L:1.85,E:null,V:1.95}},
  ]},
  {icon:"ðŸ’",name:"NHL",events:[
    {id:"h1",h:"Rangers",  a:"Bruins",   time:"01:00", odds:{L:2.10,E:null,V:1.75}},
  ]},
  {icon:"ðŸ¥Š",name:"MMA / UFC",events:[
    {id:"m1",h:"Adesanya", a:"Whittaker",time:"Dom 04:00",odds:{L:1.65,E:null,V:2.25}},
  ]},
];

const POOLS_ACTIVE = [
  {id:"p1",name:"Combo Mundial IA",picks:["Argentina gana","Brasil gana","EspaÃ±a +1.5"],pot:284500,users:47,odd:3.12,closes:"02:00hs"},
  {id:"p2",name:"ClÃ¡sico Argentino",picks:["River gana","MÃ¡s de 1.5 goles"],pot:156200,users:28,odd:2.45,closes:"21:30hs"},
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PANTALLA 1 â€” CANAL PÃšBLICO SPORTS
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        ...
        <GCard glow={Q.violet} style={{padding:"18px",marginBottom:14,
          ...
          <div style={{position:"relative",zIndex:1,textAlign:"center"}}>
            ...
            <div style={{color:Q.muted,fontSize:11,marginTop:4,marginBottom:14,fontFamily:"'Space Grotesk',system-ui"}}>
              Sports Premium Â· 4 modos de apuesta ðŸ‡¦ðŸ‡·
            </div>
            <div style={{display:"flex",gap:8,justifyContent:"center",flexWrap:"wrap",marginBottom:14}}>
              <HBadge label="âš½ Prematch" color={Q.violet}/>
              <HBadge label="ðŸ”´ En Vivo" color={Q.pink}/>
              <HBadge label="ðŸŽ¯ Pool" color={Q.gold}/>
              <HBadge label="ðŸ¤ P2P" color={Q.teal}/>
            </div>
            <QKB rows={[[{label:"Abrir QuartzPlay Sports",action:"open",primary:true,icon:"â¬¡"}]]} onPress={onBot}/>
          </div>
        </GCard>
            ...
            <div style={{display:"flex",gap:5,marginBottom:8}}>
              {[{l:ev.h,v:ev.odds.L,c:Q.amber},{l:"Empate",v:ev.odds.E,c:Q.muted},{l:ev.a,v:ev.odds.V,c:Q.cyan}]
                ...
                <div key={i} style={{flex:1,background:"rgba(255,255,255,0.04)",
                  ...
                  <div style={{color:Q.pink,fontSize:8}}>â—‰ LIVE</div>
                </div>
              ))}
            </div>
            <QKB rows={[[{label:"APOSTAR EN VIVO",action:"open",primary:true,icon:"ðŸŽ°",color:Q.pink,color2:Q.violet}]]} onPress={onBot}/>
          </GCard>
        ))}
        ...
        <GCard glow={Q.gold} style={{padding:"14px",marginBottom:14}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
            <div style={{width:28,height:28,borderRadius:8,
              ...
              display:"flex",alignItems:"center",justifyContent:"center",fontSize:14}}>ðŸŽ¯</div>
            <div>
              <div style={{color:Q.text,fontWeight:700,fontSize:13,fontFamily:"'Space Grotesk',system-ui"}}>POOL ACTIVO â€” Combo Mundial IA</div>
              <div style={{color:Q.muted,fontSize:11}}>47 jugadores Â· cierra a las 22:00hs</div>
            </div>
          </div>
          ...
          {["Argentina gana @1.30","Brasil gana @1.55","EspaÃ±a +1.5 goles @1.62"].map((p,i)=>(
            <div key={i} style={{display:"flex",alignItems:"center",gap:6,padding:"4px 0",
              borderBottom:i<2?`1px solid ${Q.dim}`:"none"}}>
              <span style={{color:Q.green,fontSize:11}}>âœ“</span>
              <span style={{color:Q.muted,fontSize:12,fontFamily:"'Space Grotesk',system-ui"}}>{p}</span>
            </div>
          ))}
          <QKB rows={[[{label:"UNIRME AL POOL",action:"open",primary:true,icon:"ðŸŽ¯",color:Q.gold,color2:Q.amber}]]} onPress={onBot}/>
        </GCard>
        ...
        <GCard glow={Q.violet} style={{padding:"14px",marginBottom:14}}>
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
            <div style={{width:28,height:28,borderRadius:8,
              background:`linear-gradient(135deg,${Q.violet},${Q.cyan})`,
              display:"flex",alignItems:"center",justifyContent:"center",fontSize:14}}>âš¡</div>
            <div>
              <div style={{color:Q.text,fontWeight:700,fontSize:13,fontFamily:"'Space Grotesk',system-ui"}}>AI COMBO #47 â€” 8/10</div>
          ...
          {[{h:"Argentina",a:"Argelia",sel:"Argentina",odd:1.30},{h:"River",a:"Boca",sel:"River",odd:1.55,live:true},{h:"R.Madrid",a:"Bayern",sel:"R.Madrid",odd:2.10,live:true}].map((p,i)=>(
            <div key={i} style={{display:"flex",justifyContent:"space-between",padding:"5px 0",
              ...
              <div>
                {p.live&&<><LiveDot/>{" "}</>}
                <span style={{color:Q.muted,fontSize:11}}>{p.h} vs {p.a} Â· </span>
          ...
          <QKB rows={[[{label:"APOSTAR COMBO",action:"open",primary:true,icon:"âš¡"}]]} onPress={onBot}/>
        </GCard>
      </div>
      ...
      <div style={{position:"fixed",bottom:0,left:"50%",transform:"translateX(-50%)",
        ...
        <button onClick={onBot} style={{
          ...
          <span style={{fontSize:20}}>â¬¡</span> Abrir QuartzPlay Sports
        </button>
      </div>
    </div>
  );
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PANTALLA 2 â€” MENÃš SPORTS EN EL BOT
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
        ...
        <BotMsg time="9:43">
          ...
          <GCard glow={Q.green} style={{padding:"12px 14px",marginBottom:12,
            ...
            <div style={{position:"relative",zIndex:1,display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              ...
              <div style={{textAlign:"right"}}>
                <HBadge label="Plan Pro â­" color={Q.violet}/>
            ...
            <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
              <div style={{display:"flex",alignItems:"center",gap:8}}>
                ...
                <div>
                  ...
                  <div style={{color:Q.muted,fontSize:10}}>River 1:0 Boca Â· R.Madrid 2:1 Bayern</div>
                </div>
              </div>
              <span style={{color:Q.pink,fontSize:18}}>â€º</span>
            </div>
          </GCard>
          ...
          <GCard glow={Q.gold} style={{padding:"10px 12px",marginBottom:12,cursor:"pointer"}}
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              <div>
                <div style={{color:Q.muted,fontSize:9,letterSpacing:1,textTransform:"uppercase",fontFamily:"'Space Grotesk',system-ui"}}>ðŸŽ¯ POOL ACTIVO</div>
                <div style={{color:Q.gold,fontWeight:900,fontSize:18,fontFamily:"'Space Grotesk',system-ui"}}>{ars(pool)}</div>
                <div style={{color:Q.muted,fontSize:10}}>47 jugadores Â· cierra 22:00hs</div>
              </div>
              <span style={{color:Q.gold,fontSize:18}}>â€º</span>
            </div>
          </GCard>
          ...
          <QKB rows={[
            [{label:"ðŸ“‹ Prematch",action:"prematch",primary:true,color:Q.violet},{label:"ðŸ”´ En Vivo",action:"live",primary:true,color:Q.pink,color2:Q.violet}],
            [{label:"ðŸŽ¯ Pool",action:"pool",primary:true,color:Q.gold,color2:Q.amber},{label:"ðŸ¤ P2P",action:"p2p",primary:true,color:Q.teal,color2:Q.blue}],
            [{label:"âš¡ AI Combo",action:"combo",icon:"âš¡"},{label:"ðŸ“Š Mis apuestas",action:"mybets",icon:"ðŸ“Š"}],
          ]} onPress={onAction}/>
        </BotMsg>
      </div>
    </div>
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PANTALLA 3 â€” PREMATCH (todos los deportes)
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        ...
        backgroundSize:"28px 28px"}}/>
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <UserMsg time="9:50">ðŸ“‹ Prematch</UserMsg>
        <BotMsg time="9:50">
          <div style={{color:Q.text,fontWeight:700,fontSize:14,marginBottom:10,fontFamily:"'Space Grotesk',system-ui"}}>ðŸ“‹ Apuestas Prematch</div>
          ...
          <QKB rows={[[{label:"â—€ Sports",action:"sports"},{label:"âš¡ AI Combo",action:"combo"}]]} onPress={onAction}/>
        </BotMsg>
        ...
        {bets.length>0&&(
          <div style={{position:"fixed",bottom:10,left:"50%",transform:"translateX(-50%)",
            ...
            <GCard glow={Q.violet} style={{padding:"12px 14px",background:"rgba(6,6,18,0.97)"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <span style={{color:Q.muted,fontSize:12}}>{bets.length} picks Â· <span style={{color:Q.cyan,fontWeight:700}}>{fmt(tot)}x</span></span>
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        ...
        backgroundSize:"28px 28px"}}/>
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <UserMsg time="9:55">ðŸ”´ En Vivo</UserMsg>
        <BotMsg time="9:55">
          ...
          <QKB rows={[[{label:"â—€ Sports",action:"sports"},{label:"ðŸ“‹ Prematch",action:"prematch"}]]} onPress={onAction}/>
        </BotMsg>
            ...
            <GCard glow={Q.pink} style={{padding:"12px 14px",background:"rgba(6,6,18,0.97)"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8}}>
                <div style={{display:"flex",alignItems:"center",gap:6}}>
                  <LiveDot/>
                  <span style={{color:Q.muted,fontSize:12}}>{bets.length} picks Â· <span style={{color:Q.pink,fontWeight:700}}>{fmt(tot)}x</span></span>
                </div>
                <span style={{color:Q.green,fontWeight:700,fontSize:12,fontFamily:"'Space Grotesk',system-ui"}}>Ret: {ars(Math.round(10000*tot))}</span>
              </div>
          ...
          <BotMsg time="10:05">
            <div style={{textAlign:"center",marginBottom:12,position:"relative"}}>
              ...
              <div style={{position:"relative",zIndex:1}}>
                <div style={{fontSize:48,marginBottom:6}}>ðŸŽ¯</div>
                <div style={{color:Q.gold,fontWeight:900,fontSize:18,fontFamily:"'Space Grotesk',system-ui",marginBottom:4}}>Â¡Te uniste al Pool!</div>
            ...
            <div style={{color:Q.amber,fontSize:11,marginBottom:10,fontFamily:"'Space Grotesk',system-ui"}}>
              ðŸ”” Te notificamos el resultado automÃ¡ticamente
            </div>
            <QKB rows={[
              [{label:"ðŸŽ¯ Ver otros pools",action:"pool"},{label:"â—€ Sports",action:"sports"}],
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        ...
        backgroundSize:"28px 28px"}}/>
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <UserMsg time="10:00">ðŸŽ¯ Pool</UserMsg>
        <BotMsg time="10:00">
          <div style={{color:Q.text,fontWeight:700,fontSize:14,marginBottom:4,fontFamily:"'Space Grotesk',system-ui"}}>ðŸŽ¯ Pools activos</div>
          <div style={{color:Q.muted,fontSize:11,marginBottom:12}}>Pozo compartido entre usuarios Â· 8% comisiÃ³n</div>
          ...
          <GCard glow={Q.violet} style={{padding:"14px",marginBottom:10}}>
            <div style={{color:Q.violet2,fontWeight:700,fontSize:13,marginBottom:6,fontFamily:"'Space Grotesk',system-ui"}}>âž• Crear mi propio pool</div>
            <div style={{color:Q.muted,fontSize:12,marginBottom:10}}>SeleccionÃ¡ tus picks, definÃ­ el monto mÃ­nimo y compartÃ­ con otros usuarios</div>
            <QKB rows={[[{label:"CREAR POOL",action:"create_pool",primary:true,icon:"ðŸŽ¯",color:Q.violet}]]} onPress={onAction}/>
          </GCard>
          <QKB rows={[[{label:"â—€ Sports",action:"sports"}]]} onPress={onAction}/>
        </BotMsg>
      </div>
    </div>
  );
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PANTALLA 6 â€” P2P ENTRE USUARIOS
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
        ...
        <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
          <BotMsg time="10:15">
            <div style={{textAlign:"center",marginBottom:12,position:"relative"}}>
              ...
              <div style={{position:"relative",zIndex:1}}>
                <div style={{fontSize:48,marginBottom:6}}>ðŸ¤</div>
                <div style={{color:Q.teal,fontWeight:900,fontSize:18,fontFamily:"'Space Grotesk',system-ui",marginBottom:4}}>Â¡Match P2P!</div>
            ...
            <GCard glow={Q.teal} style={{padding:"14px",marginBottom:12}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
                ...
                <div style={{textAlign:"center",padding:"0 10px"}}>
                  <div style={{color:Q.teal,fontSize:24}}>ðŸ¤</div>
                </div>
                <div style={{textAlign:"center",flex:1}}>
              ...
              {[
                ...
                ["Si ganÃ¡s",ars(matched.stake+matched.lay)+" ARS",Q.green],
                ["ComisiÃ³n","2%",Q.muted],
            ...
            <div style={{color:Q.amber,fontSize:11,marginBottom:10}}>ðŸ”” Te avisamos el resultado automÃ¡ticamente</div>
            <QKB rows={[
              [{label:"ðŸ¤ Ver mis apuestas P2P",action:"mybets"},{label:"â—€ Sports",action:"sports"}],
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        ...
        backgroundSize:"28px 28px"}}/>
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <UserMsg time="10:10">ðŸ¤ P2P</UserMsg>
        <BotMsg time="10:10">
          <div style={{color:Q.text,fontWeight:700,fontSize:14,marginBottom:4,fontFamily:"'Space Grotesk',system-ui"}}>ðŸ¤ Apuestas P2P</div>
          <div style={{color:Q.muted,fontSize:11,marginBottom:12}}>ApostÃ¡ directamente contra otros usuarios Â· Solo 2% de comisiÃ³n</div>
                ...
                <GCard key={offer.id} glow={Q.teal} style={{padding:"12px 14px",marginBottom:8}}>
                  ...
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                    <div>
                      ...
                      <span style={{color:Q.muted,fontSize:11}}> Â· GanÃ¡s: </span>
            ...
            <GCard glow={Q.teal} style={{padding:"14px"}}>
              ...
              {myPick&&(
                <GCard style={{padding:"10px 12px",marginBottom:12}}>
                  ...
                  <div style={{color:Q.muted,fontSize:11}}>ApostÃ¡s: <span style={{color:Q.gold,fontWeight:700}}>{ars(myStake)}</span> Â· Otros apuestan en contra</div>
                </GCard>
              )}
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PANTALLA 7 â€” APUESTA CONFIRMADA
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
      ...
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <BotMsg time="10:20">
          <div style={{textAlign:"center",marginBottom:14,position:"relative"}}>
            ...
            <div style={{position:"relative",zIndex:1}}>
              <div style={{fontSize:52,marginBottom:8,filter:`drop-shadow(0 0 16px ${Q.green})`}}>ðŸŽ°</div>
              <div style={{fontFamily:"'Space Grotesk',system-ui",fontWeight:900,fontSize:20,
                color:Q.green,textShadow:`0 0 16px ${Q.green}66`,marginBottom:4}}>Â¡Apuesta registrada!</div>
            </div>
          </div>
          ...
          <QKB rows={[
            [{label:"ðŸ”´ Ver en vivo",action:"live",primary:true,color:Q.pink}],
            [{label:"âš¡ Nuevo combo",action:"combo"},{label:"â—€ Sports",action:"sports"}],
          ]} onPress={onAction}/>
        </BotMsg>
      </div>
    </div>
...
function ScreenMyBets({ onAction }){
  const MY_BETS=[
    ...
    {id:"b4",picks:"P2P vs @champion_ar Â· Brasil",odd:1.55,stake:20000,ret:31000,status:"p2p",time:"Hoy 19:00"},
    {id:"b5",picks:"EspaÃ±a gana",odd:1.18,stake:8000,ret:9440,status:"won",time:"Ayer"},
  ...
  const labels={active:"ACTIVA",pool:"POOL",p2p:"P2P",won:"GANADA âœ“",lost:"PERDIDA âœ—"};
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        ...
        <BotMsg time="10:25">
          <div style={{color:Q.text,fontWeight:700,fontSize:14,marginBottom:12,fontFamily:"'Space Grotesk',system-ui"}}>ðŸ“Š Mis apuestas</div>
            ...
            <GCard key={bet.id} glow={colors[bet.status]} style={{padding:"12px 14px",marginBottom:8}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:6}}>
                <div style={{flex:1,marginRight:8}}>
                  ...
                  <div style={{color:Q.muted,fontSize:10}}>{bet.time} Â· {fmt(bet.odd)}x</div>
                </div>
              ...
              <div style={{display:"flex",justifyContent:"space-between"}}>
                ...
                <span style={{color:bet.status==="won"?Q.green:bet.status==="lost"?Q.red:Q.cyan,fontWeight:700,fontSize:12,fontFamily:"'Space Grotesk',system-ui"}}>
                  {bet.status==="won"?"+"+ars(bet.ret):bet.status==="lost"?"-"+ars(bet.stake):"â†’ "+ars(bet.ret)}
                </span>
              </div>
            </GCard>
          ))}
...
const AI_COMBOS = [
  {
    ...
    note:"River domina en casa Â· Argentina favorita clara Â· Francia sÃ³lida",
  },
  {
    id:"c2", name:"AI COMBO #48", conf:7, tag:"Goles & Over", tagColor:"#FFB800",
    picks:[
      {h:"EspaÃ±a",   a:"C.Verde",  sel:"MÃ¡s de 2.5 goles", odd:1.40, mkt:"O/U",    live:false},
      {h:"Brasil",   a:"Marruecos",sel:"MÃ¡s de 1.5 goles", odd:1.55, mkt:"O/U",    live:false},
      {h:"City",     a:"Arsenal",  sel:"Ambos anotan",      odd:1.70, mkt:"BTTS",   live:false},
    ],
    note:"3 partidos con alto dominio ofensivo Â· Equipos con plantilla goleadora",
  },
  {
    ...
    note:"Alta cuota Â· Favoritos en todas las ligas Â· Riesgo moderado",
  },
];
  ...
  return(
    <div style={{background:Q.void,minHeight:"100%",position:"relative"}}>
      ...
      <div style={{position:"fixed",inset:0,pointerEvents:"none",zIndex:0,
        ...
        backgroundSize:"28px 28px"}}/>
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        <UserMsg time="10:30">âš¡ Combinadas IA</UserMsg>
        <BotMsg time="10:30">
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
            <div style={{width:30,height:30,borderRadius:9,
              background:`linear-gradient(135deg,${Q.violet},${Q.cyan})`,
              display:"flex",alignItems:"center",justifyContent:"center",fontSize:16,
              boxShadow:`0 0 12px ${Q.violet}44`}}>âš¡</div>
            <div>
              <div style={{color:Q.text,fontWeight:700,fontSize:14,fontFamily:"'Space Grotesk',system-ui"}}>AI Combos del dÃ­a</div>
              <div style={{color:Q.muted,fontSize:11}}>Generados por QuartzPlay IA Â· Actualizados cada hora</div>
            </div>
          </div>
          ...
          <GCard glow={Q.violet} style={{padding:"14px",marginBottom:12,
            ...
            <NDiv color={Q.violet}/>
            <div style={{color:Q.muted,fontSize:11,fontStyle:"italic",marginBottom:10}}>ðŸ’¡ {combo.note}</div>
            ...
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:12}}>
              ...
              <div style={{textAlign:"center"}}>
                ...
                <div style={{color:Q.violet2,fontWeight:700,fontSize:16,fontFamily:"'Space Grotesk',system-ui"}}>{combo.picks.length}Ã—</div>
              </div>
              <div style={{textAlign:"right"}}>
            ...
            {!voted[sel]?(
              <button onClick={()=>{
                ...
                <span>âš¡</span> APOSTAR {ars(stake)}
              </button>
            ):(
              <GCard glow={Q.green} style={{padding:"12px",textAlign:"center"}}>
                <div style={{color:Q.green,fontWeight:700,fontSize:13,fontFamily:"'Space Grotesk',system-ui"}}>
                  âœ¦ Combo apostado Â· Retorno pot: {ars(Math.round(stake*tot))}
                </div>
              </GCard>
            )}
          </GCard>
          ...
          <GCard style={{padding:"12px 14px",marginBottom:10}}>
            ...
            {[
              ...
              {n:"Combo #44",res:"PERDIDO",odd:"3.44x",ret:"â€”",c:Q.red},
              ...
              <div key={i} style={{display:"flex",justifyContent:"space-between",alignItems:"center",
                ...
                <span style={{color:Q.muted,fontSize:12,fontFamily:"'Space Grotesk',system-ui"}}>{h.n} Â· {h.odd}</span>
            ...
            <div style={{color:Q.muted,fontSize:10,marginTop:8,fontFamily:"'Space Grotesk',system-ui"}}>
              Acierto semanal: <span style={{color:Q.green,fontWeight:700}}>75%</span> Â· 3/4 combos ganados
            </div>
          </GCard>

          <QKB rows={[
            [{label:"ðŸ“‹ Prematch",action:"prematch"},{label:"ðŸ”´ En Vivo",action:"live"}],
            [{label:"â—€ Sports",action:"sports"}],
          ]} onPress={onAction}/>
        </BotMsg>
      </div>
    </div>
...
const STEPS=[
  {k:"canal",    l:"ðŸ“¢ Canal"},
  {k:"sports",   l:"ðŸ  Sports"},
  {k:"prematch", l:"ðŸ“‹ Prematch"},
  {k:"live",     l:"ðŸ”´ En Vivo"},
  {k:"pool",     l:"ðŸŽ¯ Pool"},
  {k:"p2p",      l:"ðŸ¤ P2P"},
  {k:"combo",    l:"âš¡ Combos IA"},
  {k:"confirmed",l:"âœ… Confirmada"},
  {k:"mybets",   l:"ðŸ“Š Mis apuestas"},
];
  ...
  return(
    <div style={{maxWidth:430,margin:"0 auto",fontFamily:"system-ui,-apple-system,sans-serif",background:Q.void,minHeight:"100vh"}}>
      ...
      <div style={{background:"#000",padding:"10px 20px 6px",display:"flex",justifyContent:"space-between",
        ...
        <div style={{display:"flex",gap:6,fontSize:12}}><span>ðŸ“¶</span><span>ðŸ”‹</span></div>
      </div>
      ...
      {isCanal?(
        <div style={{background:Q.deep,borderBottom:`1px solid ${Q.border}`,
          ...
          <div style={{width:42,height:42,borderRadius:"50%",
            ...
            boxShadow:`0 0 16px ${Q.violet}66`}}>â¬¡</div>
          <div style={{flex:1}}>
            <QPLogo size={16}/>
            <div style={{color:Q.muted,fontSize:11,marginTop:1}}>12.847 suscriptores Â· Canal verificado</div>
          </div>
        </div>
      ):(
        <TgHeader title="QuartzPlay Sports" sub="â— en lÃ­nea"
          onBack={()=>{
      ...
      <div style={{background:Q.deep,borderBottom:`1px solid ${Q.border}`,
        ...
        {STEPS.map((s,i,arr)=>(
          <div key={s.k} style={{display:"flex",alignItems:"center",gap:2,flexShrink:0}}>
            ...
            {i<arr.length-1&&<span style={{color:Q.dim,fontSize:9}}>â€º</span>}
          </div>
        ))}
      </div>
