...
async def sportradar_test_cuotas(_=Depends(auth.require_admin)):
    ...
    intentos = [
        ...
        ("OC Prematch v2 schedule",
         f"https://api.sportradar.com/oddscomparison-prematch/{al}/v2/{lg}/sports/sr:sport:1/schedules.json"),
        ("OC usprematch v2 books",
         f"https://api.sportradar.com/oddscomparison-usprematch/{al}/v2/{lg}/books.json"),
        ("OC Regular v1 sports",
         f"https://api.sportradar.com/oddscomparison/{al}/v1/{lg}/sports.json"),
        ("OC Prematch v1 sports",
         f"https://api.sportradar.com/oddscomparison-prematch/{al}/v1/{lg}/sports.json"),
    ]
    resultados = []
    async with httpx.AsyncClient(timeout=20) as client:
