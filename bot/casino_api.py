...
# Deportes de Odds Comparison. Se pueden sumar mas; cada uno cuesta
# llamadas, asi que conviene habilitar solo los que se ofrecen.
SR_DEPORTES = [
...
# 10 minutos. Las cuotas prematch no se mueven tanto como para pagar
# seis llamadas a Sportradar cada 3 minutos, y cada armado dejaba al
# admin esperando.
_SR_ALL_TTL = 600
