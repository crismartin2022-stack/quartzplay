...
async def sportradar_inspeccionar_cuotas(variante: int = 1, _=Depends(auth.require_admin)):
    ...
    sid = "sr:sport:1"
    rutas = {
        1: f"/sports/{sid}/{dia}/summaries.json",
        2: f"/sports/{sid}/{dia}/sport_event_markets.json",
        3: f"/sports/{sid}/schedules.json",
        4: f"/schedules/{dia}/sport_event_markets.json",
        5: f"/sports/{sid}/{dia}/schedule.json",
        6: f"/sport_events/{dia}/summaries.json",
    }
