...
async def agencia_cierre(desde: str = "", hasta: str = "",
    ...
    return {
        ...
        "total": {
            ...
            "ggr": round(tot_apostado - tot_premios,2),
...
async def admin_cierre(desde: str = "", hasta: str = "", export: str = "",
    ...
    return {
        ...
        "global": {
            ...
            "ggr": round(tot_apostado - tot_premios,2),
            "comisiones": round(tot_com,2),
            "neto_casa": round((tot_apostado - tot_premios) - tot_com,2),
        },
        "agencias": filas,
    }
...
async def admin_hist_movimientos(agencia: str = "", desde: str = "",
    ...
    async with pool.acquire() as conn:
        ...
        if desde:
            args2.append(desde); cond2.append(f"am.created_at::date >= ${len(args2)}")
        if hasta:
            args2.append(hasta); cond2.append(f"am.created_at::date <= ${len(args2)}")
