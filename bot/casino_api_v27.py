...
async def sportradar_test_cuotas(_=Depends(auth.require_admin)):
    ...
    intentos = [
        ("Odds Comparison Prematch",
         f"https://api.sportradar.com/oddscomparison-prematch/{SPORTRADAR_ACCESS}/v4/{SPORTRADAR_LANG}/sport_events/schedule.json"),
        ("Odds Comparison Live",
         f"https://api.sportradar.com/oddscomparison-liveodds/{SPORTRADAR_ACCESS}/v1/{SPORTRADAR_LANG}/sport_events/live.json"),
        ("Odds Comparison v2",
         f"https://api.sportradar.com/odds-comparison/{SPORTRADAR_ACCESS}/v2/{SPORTRADAR_LANG}/sports/sr:sport:1/schedules.json"),
    ]
    resultados = []
    async with httpx.AsyncClient(timeout=20) as client:
