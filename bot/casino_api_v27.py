...
def _sr_evento_a_app(item):
    ...
    Devuelve un dict tipo el de The Odds API o None si no tiene 1X2."""
    ...
    if not cuotas or not home or not away:
        return None
    return {
        "id": ev.get("id"),
        "event_id": ev.get("id"),
        ...
        "home_odd": cuotas.get("home"),
        "draw_odd": cuotas.get("draw"),
        "away_odd": cuotas.get("away"),
