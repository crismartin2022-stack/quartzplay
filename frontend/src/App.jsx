...
// ═══════════════════════════════════════════════════════════════
function ScreenBetConfirmed({ bets, stake, odd, code, onAction, onRepetir }){
      ...
      {!abierto&&(
        <button onClick={()=>setAbierto(true)} aria-label="Ayuda"
          style={{position:"fixed",left:14,
            bottom:"calc(76px + env(safe-area-inset-bottom))",zIndex:80,
            width:44,height:44,borderRadius:22,
            background:ov(0.10),border:`1px solid ${Q.border}`,
            backdropFilter:"blur(10px)",cursor:"pointer",fontSize:19,
            display:"flex",alignItems:"center",justifyContent:"center"}}>
          💬</button>
      )}
      {abierto&&(
  ...
  return(
    <div style={{maxWidth:520,margin:"0 auto",
      ...
      <div style={{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",
        ...
        {screen==="confirmed" &&<ScreenBetConfirmed bets={betData.bets} stake={betData.stake} odd={betData.odd} code={betData.code} onAction={handle} onRepetir={repetirApuesta}/>}
