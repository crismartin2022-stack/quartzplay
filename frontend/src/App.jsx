...
function EstadisticasPartido({ ev, onCerrar }){
  ...
  useEffect(()=>{
    const q=`home=${encodeURIComponent(home)}&away=${encodeURIComponent(away)}&fecha=${fecha}`;
  ...
  return(
    <div style={{position:"fixed",inset:0,zIndex:100,background:"rgba(2,2,8,0.92)",
      ...
      <div onClick={e=>e.stopPropagation()} style={{background:Q.void,
        ...
        {tab==="stats"&&(
          <div>
            ...
            {stats&&stats.tiene_stats&&stats.stats.map((s,i)=>{
        ...
        {tab==="previa"&&(
          <div>
            ...
            {previa&&(previa.head_to_head||[]).length>0&&(
              <div>
            ...
            <div style={{marginTop:16}}>
              ...
              {srPartidos
                ...
                <GCard key={`sr-${i}`} style={{padding:12,marginBottom:8}}>
                      ...
                      {srExpand[p.id]&&(
                        <div style={{marginTop:6,display:"flex",flexWrap:"wrap",gap:5}}>
                          {p.mercados.filter(m=>m.market!=="1x2").map((m,mi)=>(
                            <button key={mi}
                              onClick={()=>toggle({id:p.id,h:p.home,a:p.away},m.label,m.odd)}
                  ...
                  <EstadisticasPartidoBoton ev={{h:p.home,a:p.away,commence_time:p.commence_time}}/>
                </GCard>
              ))}
            </div>
          )}
