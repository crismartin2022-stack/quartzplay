  ...
  return(
    <div>
      <div style={{display:"flex",gap:6,marginBottom:12}}>
        {[["resumen","📊 Resumen"],["productos","🎰 Productos"],["caja","🧾 Caja"],["movimientos","💸 Movs"],["apuestas","🎫 Apuestas"],["cashout","💰 Cash out"],["combos","⚡ Combos"]].map(([k,l])=>(
    ...
    <div>
      ...
      {d&&(
        <GCard style={{padding:15,marginTop:12}}
          ...
          {/* Las pruebas del sistema van con el diagnóstico: son lo
              mismo, revisar que todo esté funcionando. */}
