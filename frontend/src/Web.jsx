  ...
  const Item = ({it}) => {
    ...
    return(
      <button onClick={()=>onNav(it.k)}
        ...
        <span style={{fontSize:17,opacity:on?1:.5}}>{it.i}</span>
        <span style={{color:on?Q.gold:Q.muted,fontSize:8.5,
      ...
      <div style={{display:"flex",alignItems:"flex-end",
        ...
        <button onClick={()=>onNav("mejorar")}
          ...
          style={{flexShrink:0,width:52,height:52,borderRadius:"50%",
            border:"none",cursor:"pointer",margin:"0 2px -10px",
          ...
          <span style={{color:"#1a1200",fontSize:8,fontWeight:900,
  ...
  return(
    <div style={{background:Q.void,color:Q.text,minHeight:"100dvh",
      ...
      <header style={{background:Q.deep,borderBottom:`1px solid ${Q.border}`,
        ...
        <button onClick={()=>setVista("mejorar")}
          style={{display:"flex",alignItems:"center",gap:8,
            background:Q.goldBg,border:"none",cursor:"pointer",
            borderRadius:7,padding:"9px 15px",whiteSpace:"nowrap"}}>
