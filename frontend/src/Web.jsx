...
function CasinoWeb({ sesion, ancho }){
  ...
  useEffect(()=>{
    fetch(`${API}/api/casino/juegos`)
      ...
      .then(d=>{
        ...
        // En el sitio se muestran todos: la pantalla grande aguanta
        // los juegos de escritorio, que en el teléfono se ven rotos.
        setJuegos(d.juegos||[]);
        setMarcas(d.marcas||[]);
      })
      .catch(()=>setJuegos([]));
  ...
  return(
    <div style={{padding:"12px 12px 20px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:ancho?"repeat(6,1fr)":"1fr 1fr 1fr",
        gap:8}}>
        {visibles.map(j=>(
