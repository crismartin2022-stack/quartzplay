  ...
  return(
    <div>
      <div style={{display:"flex",gap:6,marginBottom:12}}>
        {[["resumen","📊 Resumen"],["movimientos","💸 Movs"],["apuestas","🎫 Apuestas"],["combos","⚡ Combos"]].map(([k,l])=>(
...
function CrearInfluencer({ adminKey, onListo, onNoAutorizado }){
  const [form,setForm]=useState({name:"",username:"",password:"",pct_ggr:"",pct_ventas:"",parent_code:""});
  const [ags,setAgs]=useState([]);
  const [msg,setMsg]=useState("");
