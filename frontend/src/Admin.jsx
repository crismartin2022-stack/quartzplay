    ...
    <div>
      ...
      {catalogo.length>0&&(
        <div style={{display:"flex",gap:5,overflowX:"auto",marginBottom:10,
          ...
          {catalogo.map(c=>(
            <button key={c.key} onClick={()=>setFDeporte(
                fDeporte===c.key?"":c.key)} style={{
      ...
      <input value={fLiga} onChange={e=>setFLiga(e.target.value)}
        placeholder="Filtrar por liga (ej: Premier, Libertadores)"
        style={{width:"100%",background:"rgba(255,255,255,0.05)",
          border:`1px solid ${fLiga?Q.cyan:Q.border}`,borderRadius:9,
          padding:"9px 12px",color:Q.text,fontSize:13,marginBottom:10,
          fontFamily:"'Space Grotesk',system-ui"}}/>
