          ...
          <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:10}}>
            ...
            <div>
              <div style={{color:Q.text,fontWeight:700,fontSize:13,
                fontFamily:"'Space Grotesk',system-ui"}}>
                {(combo.name||combo.nombre||"Combo")}{combo.conf?` — ${combo.conf}/10`:""}
              </div>
              {combo.tag&&<HBadge label={combo.tag} color={combo.tagColor||Q.green}/>}
            </div>
          </div>
          ...
          <div style={{display:"flex",justifyContent:"space-between",marginBottom:10}}>
            <div>
              ...
              <div style={{color:Q.gold,fontWeight:900,fontSize:20,
                fontFamily:"'Space Grotesk',system-ui"}}>
                {fmt(combo.odd_total||prod((combo.picks||[]).map(p=>p.odd||1)))}x
              </div>
            </div>
            <div style={{textAlign:"right"}}>
              ...
              <div style={{color:Q.green,fontWeight:900,fontSize:18,
                fontFamily:"'Space Grotesk',system-ui"}}>
                {ars(Math.round(10000*(combo.odd_total||prod((combo.picks||[]).map(p=>p.odd||1)))))}
              </div>
            </div>
          </div>
      ...
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        ...
        <BotMsg time="9:43">
          ...
          <QKB rows={[
            ...
            [{label:"📸 Mejorar mi apuesta",action:"mejorar",primary:true,
              color:Q.cyan,color2:Q.violet}],
          ]} onPress={onAction}/>
        </BotMsg>
      </div>
    </div>
    ...
    <div style={{maxWidth:520,margin:"0 auto",
      ...
      {isCanal?(
        ...
        <TgHeader title="QuartzPlay Sports" sub="● en línea"
          onBack={()=>{
            const prev={sports:"home",prematch:"home",live:"home",
              pool:"home",p2p:"home",combo:"home",confirmed:"home",mybets:"home",
              cuenta:"home",mejorar:"home"};
