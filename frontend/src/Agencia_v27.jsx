      ...
      {!slip&&reservas.length>0&&(
        <GCard style={{padding:14,marginBottom:12}}>
            ...
            <div key={r.code} onClick={()=>{ setCode(r.code); setErr(""); }}
              ...
              <div style={{minWidth:0,flex:1}}>
                <div style={{display:"flex",alignItems:"center",gap:7}}>
                  ...
                  {!r.de_mi_rama&&(
                    <span style={{color:Q.cyan,fontSize:8.5,fontWeight:700,
                      border:`1px solid ${Q.cyan}55`,borderRadius:5,
                      padding:"1px 5px"}}>NUEVO</span>
                  )}
                </div>
          ...
          <div style={{color:Q.dim,fontSize:10,marginTop:8,lineHeight:1.5,
            fontFamily:"'Space Grotesk',system-ui"}}>
            Tocá una para cargarla en el buscador. Las marcadas como
            NUEVO son de clientes sin agencia: cobrarlas los suma a la tuya.</div>
        </GCard>
      )}
