...
// ═══════════════════════════════════════════════════════════════
function ScreenPrematch({ onAction, onBet, onLocal, moneda }){
...
// ═══════════════════════════════════════════════════════════════
function ScreenLive({ onAction, onBet, onLocal, moneda }){
  const [bets,setBets]=useState([]);
...
// PANTALLA 7 — AI COMBO
// ═══════════════════════════════════════════════════════════════
function ScreenCombo({ onAction, onBet, refCode, onEditar, moneda }){
      ...
      <div style={{position:"relative",zIndex:1,padding:"14px 12px 80px"}}>
        ...
        <BotMsg time="10:30">
          ...
          <GCard glow={Q.violet} style={{padding:"14px",marginBottom:12,
            ...
            {/* Monto: fichas rápidas según la moneda, más campo libre.
                Antes era una constante de 10.000 que no se podía tocar. */}
            <div style={{display:"flex",gap:5,marginTop:10,marginBottom:6}}>
              {montosDe(moneda).map(v=>(
            ...
            <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:4}}>
              ...
              <input type="number" inputMode="numeric" min="0" value={stake}
                ...
                style={{flex:1,minWidth:0,background:ov(0.05),
                  ...
                  padding:"6px 9px",color:Q.text,fontSize:13,fontWeight:700,
                  fontFamily:"'Inter',system-ui"}}/>
            </div>
  ...
  return(
    <div style={{maxWidth:520,margin:"0 auto",
      ...
      <div style={{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",
        ...
        {screen==="combo"     &&<ScreenCombo        onAction={handle} onBet={confirmBet} refCode={refCode} onEditar={cargarComboAlBuilder} moneda={user?.moneda}/>}
