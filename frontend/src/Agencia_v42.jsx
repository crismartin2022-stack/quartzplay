...
function MejorarCombinada({ agencia, onSesionExpirada }){
  ...
  const estados={
    ...
    // El sistema no está seguro del partido pero tomó el más
    // parecido. Se marca para revisar en vez de rechazarlo: decir
    // "no lo tenemos" y ofrecerlo al corregir confundía al cajero.
    sugerido:{t:"Revisá el partido",c:Q.amber},
        ...
        <div>
          ...
          {res.picks.map((p,i)=>{
            ...
            <GCard key={i} glow={p.odd_final?est.c:undefined}
              ...
              {/* Qué partido tomó cuando no estaba seguro */}
              {p.aviso&&(
                <div style={{color:Q.amber,fontSize:11,marginBottom:7,
                  lineHeight:1.45,
                  fontFamily:"'Space Grotesk',system-ui"}}>
                  ⚠️ {p.aviso}</div>
              )}
