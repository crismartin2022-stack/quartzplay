    ...
    <>
      {!abierto&&(
        <button onClick={()=>setAbierto(true)} aria-label="Ayuda"
          style={{
            // Anclado abajo a la derecha y por encima de todo. Antes
            // se calculaba contra la ventana y en Telegram, que tiene
            // su propia altura de vista, quedaba fuera de pantalla.
